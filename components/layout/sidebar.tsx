"use client"
import { Activity, Book, Brain, Code, FileText, Github, Home, Linkedin, Mail, Menu, Music, User, X } from "lucide-react"
...
import { formatHashLink, isHashLink, scrollToSection } from "@/lib/utils/navigation"
...
const socialLinks = [
  { name: "GitHub", href: "https://github.com/ZoOtMcNoOt", icon: Github },
  { name: "LinkedIn", href: "https://www.linkedin.com/in/grant-mcnatt/", icon: Linkedin },
  { name: "Email", href: "mailto:gmcnatt1@tamu.edu", icon: Mail },
]
